...
export function add_models(scene, all_appartments) {
  ...
  let white_lightmap_2 = texture_loader.load('resources/2020/04/white-lightmap-2.jpg');
  {
    ...
    function add_animation(animation_start_scale, animation_target_scale, sphere) {
      var animation = new TWEEN.Tween({ target_scale: animation_start_scale }).to(
        { target_scale: animation_target_scale },
    ...
    {
      var path = [new THREE.Vector3(0, 0, 0), new THREE.Vector3(0, 0, z_base + 2.5)];
...
function loadMainBuilding(
  loader,
  texture_loader,
  white_lightmap,
  white_lightmap_2,
  on_load_texture,
  new_merged_glass_map,
  beton_texture,
  reflection_material,
) {
  let env_grass_map;
...
export function find_n_clone_material(object_to_work, object_from_clone) {
...
function loadEnvironment(loader, texture_loader, on_load_texture) {
  loader.load(
    'resources/enviroment/enviroment.fbx',
    function (enviroment) {
      const mainEnvironmentLightMap = texture_loader.load(
        'resources/enviroment/lightmaps/complete-opt.jpg',
        on_load_texture,
      );
      ...
      const concretteMap = texture_loader.load(
        'resources/material/textures/concrette_diffuse_2_o.jpg',
        on_load_texture,
      );

      const roadMapsTextures = [
        'Road_2_Material_7168_AlbedoTransparency',
        'Road_2_Material_7169_AlbedoTransparency',
        'Road_2_Material_7170_AlbedoTransparency',
      ];
          ...
          case 'Enviroment': {
            env_item.material.forEach((environmentMaterial) => {
              switch (environmentMaterial.name) {
                ...
                case 'glass': {
                  environmentMaterial.envMap = texture_loader.load(
                    'resources/material/textures/360_half.jpg',
                    on_load_texture,
                  );
                  environmentMaterial.lightMap = mainEnvironmentLightMap;
...
function loadBoxes(
  ...
  loader.load(
    ...
    function (boxes_model) {
      ...
      let new_merged_lm_12_20 = texture_loader.load(
        'resources/new_merged/lightmaps/12-20_lightmap.jpg',
        on_load_texture,
      );
      textures_counter++;
      new_merged_lm_12_20.encoding = THREE.LinearEncoding;

      let new_merged_lm_21_43 = texture_loader.load(
        'resources/new_merged/lightmaps/21-43_lightmap_2.jpg',
        on_load_texture,
      );
      textures_counter++;
      new_merged_lm_21_43.encoding = THREE.LinearEncoding;

      let new_merged_lm_lobby = texture_loader.load(
        'resources/new_merged/lightmaps/Lobby_lightmap.jpg',
        on_load_texture,
      );
      textures_counter++;
    ...
    //   var building = [];
      ...
      let int_3be = ['3Be-suite-hr.jpg'];
      let int_3me = ['3Me-salon-hrv3.jpg', '3Me-suite-hr.jpg'];
      let int_4a = ['4An-salon-hr.jpg'];
      let int_4mwn = ['4Mwn-salon-hr.jpg', '4Mwn-suite-hr.jpg'];
      let int_4pwn = ['4Pwn_suite-hr.jpg', '4Pwn-salon-hr.jpg'];
      let int_4wn = ['4wn-salon-hr.jpg'];
      let int_5pw = ['5Pwn-salon-hr.jpg', '5Pws-salon-hr.jpg', '5Pws-salon-v2-hr.jpg', '5Pws-suite-hr.jpg'];
      let int_5wn = ['5wn-balcony-hr.jpg', '5wn-salon-hr.jpg', '5wn-suite-hr.jpg'];
        int_360_array_imgs = {
        '3Ben': int_3be,
        '3Bes': int_3be,
        '3Me': int_3me,
      ...
      function add_building(elements_array, building_array) {
        ...
        var floor_type_41_46_center_mesh = new THREE.Mesh(
          floor_type_5_7_center_geometry,
          floor_type_5_7_center_material,
        );
